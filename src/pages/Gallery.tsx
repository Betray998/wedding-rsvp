...
export default function Gallery() {
  ...
  return (
    <div className="min-h-[100svh] overflow-hidden bg-neutral-900 flex flex-col items-center justify-center relative">
      ...
      {currentPage !== images.length && currentPage !== images.length + 1 && (
        <div className="absolute bottom-2 left-1/2 -translate-x-1/2 z-50 pb-safe">
          <button
            onClick={() => navigate("/")}
